...
export const hero = {
    ...
    subheadline: 'Give your platform crypto in an afternoon. Transparent fees, built-in KYC, and a dashboard that shows exactly what happened — so your compliance team stops asking questions.',
    cta: 'Open the demo',
...
export const safety = {
    ...
    disclaimer: 'This is a demo/simulation environment. Regulatory compliance claims are not made. Production integrations require real KYC and risk infrastructure.',
};
...
export const coinifyInspired = {
    ...
    subheadline: 'The widget embeds in a single script tag. KYC, risk checks, fee logic, and ledger entries are not your problem — they are already there, running quietly, explaining themselves to anyone who asks.',
    embedStory: {
    ...
    whiteLabel: {
        ...
        detail: 'The widget inherits your colours, shows your logo, and speaks your permitted currency list. Your users never need to know what is running underneath — unless they ask, in which case you can tell them it is Prodigy, and that it explains itself.',
    },
    plugAndPlay: {
    ...
    revenueAngle: {
        ...
        detail: 'Set your platform fee. Set your partner share. Every transaction posts the split to your partner statement automatically. Revenue tracking without a side project in Excel.',
    },
};
